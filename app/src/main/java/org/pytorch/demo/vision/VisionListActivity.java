...
public class VisionListActivity extends AbstractListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.vision_card_qmobilenet_click_area).setOnClickListener(v -> {
            ...
            intent.putExtra(ImageClassificationActivity.INTENT_MODULE_ASSET_NAME, "mobilenet_v2" +
                    ".pt");
        ...
        findViewById(R.id.vision_card_handmesh_click_area).setOnClickListener(v -> {
            final Intent intent = new Intent(VisionListActivity.this, HandmeshActivity.class);
            intent.putExtra(ImageClassificationActivity.INTENT_MODULE_ASSET_NAME, "handmesh_v5" +
                    ".ptl");
            intent.putExtra(ImageClassificationActivity.INTENT_INFO_VIEW_TYPE,
                    InfoViewFactory.INFO_VIEW_TYPE_IMAGE_CLASSIFICATION_HANDMESH);
            startActivity(intent);
        });
    }
