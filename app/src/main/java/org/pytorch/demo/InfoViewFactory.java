...
public class InfoViewFactory {
    ...
    public static final int INFO_VIEW_TYPE_IMAGE_CLASSIFICATION_HANDMESH = 4;


    public static View newInfoView(Context context, int infoViewType,
        ...
        if (INFO_VIEW_TYPE_IMAGE_CLASSIFICATION_RESNET == infoViewType) {
            ...
            StringBuilder sb =
                    new StringBuilder(context.getString(R.string.vision_card_resnet_description));
            ...
            StringBuilder sb =
                    new StringBuilder(context.getString(R.string.vision_card_qmobilenet_description));
            if (additionalText != null) {
                sb.append('\n').append(additionalText);
            }
            descriptionTextView.setText(sb.toString());
            ...
            return view;
        } else if (INFO_VIEW_TYPE_IMAGE_CLASSIFICATION_HANDMESH == infoViewType) {
            View view = inflater.inflate(R.layout.info, null, false);
            TextView infoTextView = view.findViewById(R.id.info_title);
            TextView descriptionTextView = view.findViewById(R.id.info_description);

            infoTextView.setText(R.string.vision_card_handmesh_title);
            StringBuilder sb =
                    new StringBuilder(context.getString(R.string.vision_card_handmesh_description));
            if (additionalText != null) {
                sb.append('\n').append(additionalText);
            }
            descriptionTextView.setText(sb.toString());
